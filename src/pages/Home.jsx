  ...
  return (
    <section className="section-home">
      <div className="container">
        ...
        <p className="bio">Empowering Black communities through open-source innovation by building accessible technology and creating pathways for future innovators.</p>
